...
public class BaseClass {
   ...
   static Properties prop;
	...
	public static String getCoopBaseURI() {
		prop = loadProperties();
		String baseURI = (String) prop.get("coopBaseURI");
		System.out.println("Base URI is: "+baseURI);
		return baseURI;
	}
	
	
		public static String getCoopApiToken() {
		
		prop = loadProperties();
		String baseURI = (String) prop.get("createTokenCoopBaseURI");
